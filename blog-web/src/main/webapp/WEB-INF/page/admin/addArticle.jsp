    ...
    <form class="form form-horizontal" id="form-article-add"
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="" placeholder="" id="title" name="title" value="">
            </div>
        </div>
        <div class="row cl">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <section id="my-editor">
                    <textarea id="txt-content" data-autosave="editor-content" name="code" autofocus required></textarea>
                </section>
            </div>
        </div>
        <div class="row cl">
...
<script type="text/javascript">
    ...
    function save(status, msg) {
        console.log($('#form-article-add').serialize() + "&status=" + status);
